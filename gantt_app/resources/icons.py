...
ICON_STROKES: Dict[str, List[tuple]] = {
    ...
    # The usage grid: the person above the rows their work is listed in.
    'resource_grid': [
        ('ellipse', [(0.38, 0.06), (0.62, 0.30)]),
        ('line', [(0.26, 0.44), (0.32, 0.34), (0.68, 0.34),
                  (0.74, 0.44)]),
        ('shape', [(0.08, 0.54), (0.92, 0.54), (0.92, 0.92),
                   (0.08, 0.92)]),
        ('line', [(0.08, 0.67), (0.92, 0.67)]),
        ('line', [(0.08, 0.80), (0.92, 0.80)]),
        ('line', [(0.38, 0.54), (0.38, 0.92)]),
        ('line', [(0.64, 0.54), (0.64, 0.92)]),
    ],
    # Levelling: the balance scale - a post, a beam, and the two pans.
    'level': [
        ('line', [(0.50, 0.10), (0.50, 0.78)]),
        ('line', [(0.16, 0.22), (0.84, 0.22)]),
        ('line', [(0.16, 0.22), (0.08, 0.52), (0.24, 0.52),
                  (0.16, 0.22)]),
        ('line', [(0.84, 0.22), (0.76, 0.52), (0.92, 0.52),
                  (0.84, 0.22)]),
        ('line', [(0.30, 0.88), (0.70, 0.88)]),
        ('line', [(0.50, 0.78), (0.38, 0.88)]),
        ('line', [(0.50, 0.78), (0.62, 0.88)]),
    ],
